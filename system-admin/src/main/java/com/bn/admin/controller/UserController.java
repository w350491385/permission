...
import com.bn.utils.PasswordUtil;
    ...
    public Result save(@RequestBody SysUser record) {
        ...
        if(record.getPassword() != null) {
            if(user == null) {
                ...
                PasswordData passwordData = PasswordUtil.encryptPassword(record.getPassword());
                record.setSalt(passwordData.getSalt());
                record.setPassword(passwordData.getPassword());
            } else {
                // 修改用户, 且修改了密码
